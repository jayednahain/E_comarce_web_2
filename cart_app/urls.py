...
urlpatterns = [
    ...
    path('remove_amount/<int:product_id>',remove_product_amount,name='remove_product_amount'),
    path('remove_cart_product/<int:product_id>',remove_product,name='remove_cart_product')
